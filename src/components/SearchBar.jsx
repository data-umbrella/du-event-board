  ...
  return (
    <div className="search" id="search">
      <div className="search__container">
        ...
        <div className="search__row search__row--date" style={{ alignItems: "center", flexWrap: "wrap", display: "flex", gap: "0.75rem" }}>
          <div
            className={
          ...
          {dateFilterType !== "customDate" && (
            <div className="search__date-group" style={{ display: 'flex', gap: '0.75rem', alignItems: 'center', flexWrap: 'wrap' }}>
              <input
                ...
                value={rangeStart}
                onChange={(e) => {
                  if (dateFilterType !== "customRange") onDateFilterTypeChange("customRange");
                  onRangeStartChange(e.target.value);
                }}
                aria-label="Range start date"
                style={{ width: "160px" }}
              />
              <span className="search__date-separator" style={{ color: "var(--text-muted)" }}>—</span>
              <input
                id="range-end-input"
